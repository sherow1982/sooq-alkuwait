...
# -*- coding: utf-8 -*-
"""
سكريبت تحديث جميع صفحات المنتجات (1977 منتج)
تطبيق نظام تحميل ديناميكي من JSON
"""

import json
from pathlib import Path

print("🚀 بدء تحديث جميع صفحات المنتجات...")
print("="*70)
...
# القالب الموحد لجميع صفحات المنتجات
...
<head>
    ...
    <meta name="description" content="منتج متوفر في سوق الكويت مع شحن مجاني">
...
print(f"🚀 بدء تحديث {len(products)} صفحة...")
print("="*70)
...
print("="*70)
print(f"✨ تم تحديث {success} صفحة بنجاح!")
