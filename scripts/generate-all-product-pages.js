 ...
 * لاستخدام هذا السكريبت: node scripts/generate-all-product-pages.js
 */
...
// دالة تصنيف المنتجات (متطابقة مع products-catalog.html)
...
function generateProductPageHTML(product) {
    ...
    const discount = Math.max(0, Math.round(((product.price - product.sale_price) / product.price) * 100));
    ...
    const baseUrl = 'https://sooq-alkuwait.arabsad.com/sooq-alkuwait';
                ...
                <div class="product-grid">
                    ...
                    <div class="product-info">
                        ...
                        <div class="action-buttons">
                            <a href="https://wa.me/201110760081?text=${encodeURIComponent('مرحباً، أريد طلب: ' + product.title + ' - السعر: ' + product.sale_price + ' د.ك - رقم المنتج: SOOQ-' + product.id.toString().padStart(4, '0'))}" 
...
console.log('\nلتشغيل مولد الفيدز: npm run build:feeds');
console.log('للبناء الشامل: npm run build');
