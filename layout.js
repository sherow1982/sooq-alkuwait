// layout.js - الإصدار المصحح (مع قائمة الموبايل)
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // --- 1. كود الهيدر (شريط علوي + نافبار + قائمة موبايل) ---
    const headerHTML = `
        <!-- Top Bar -->
            ...
            <div class="container mx-auto px-4 py-3 md:py-4">
                <div class="flex justify-between items-center">
                    ...
                    <div class="hidden md:flex gap-8 text-sm font-bold">
                        ...
                        <a href="terms.html" class="${isActive('terms')} transition">الشروط</a>
                    </div>
        ...
        <footer class="bg-gray-900 text-gray-400 py-10 md:py-12 border-t border-gray-800 mt-auto text-sm font-tajawal relative z-10">
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
                    ...
                    <div>
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-start gap-3">
                                <span class="mt-1 text-gray-500"><i class="fa-solid fa-map-pin"></i></span>
                            ...
                            <li class="flex items-center gap-3">
                                ...
                                <a href="mailto:sherow1982@gmail.com" class="hover:text-white transition break-all">sherow1982@gmail.com</a>
                            </li>
                            <li class="flex items-center gap-3">
                                <span class="text-green-500 text-lg"><i class="fa-brands fa-whatsapp"></i></span>
                                <a href="https://wa.me/201110760081" target="_blank" class="hover:text-white transition font-bold text-lg dir-ltr">+201110760081</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            ...
                            <li><a href="privacy-policy.html" class="hover:text-secondary transition block py-1">الخصوصية</a></li>
                    ...
                    <div>
                        ...
                        <p class="mb-4 text-xs leading-relaxed opacity-80">نوفر لكم خيارات دفع آمنة ومتعددة لتسهيل عملية الشراء.</p>
                ...
                <div class="border-t border-gray-800 mt-10 pt-6 text-center text-xs flex flex-col md:flex-row justify-between items-center gap-2">
                    ...
                    <p class="opacity-40">Store Version 1.2</p>
                </div>
            </div>
        </footer>
    `;
    ...
    // 2. تحديث عداد السلة (إذا كانت دالة التحديث موجودة)
    if (typeof updateCartCount === 'function') {
        setTimeout(updateCartCount, 100); // تأخير بسيط لضمان تحميل السلة
    }
});
